...
class DistilTokenPoseHead(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.conv2d = nn.Conv2d(in_channels=40, out_channels=48, kernel_size=1)
        ...
        if loss_heatmap is not None:
            self.heatmap_loss = build_loss(loss_heatmap)
        else:
