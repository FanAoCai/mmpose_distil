...
class TransformerBasePose(nn.Module, metaclass=ABCMeta):
    ...
    def train_step(self, judgement, data_batch, optimizer, **kwargs):
        ...
        Returns:
            dict: It should contain at least 3 keys: ``loss``, ``log_vars``,
                ...
                averaging the logs.
        """
        losses = self.forward(judgement, **data_batch)
    ...
    def val_step(self, judgement, data_batch, optimizer, **kwargs):
        ...
        """
        results = self.forward(judgement, return_loss=False, **data_batch)
