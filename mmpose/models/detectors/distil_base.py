...
class DistilBasePose(nn.Module, metaclass=ABCMeta):
    ...
    def train_step(self, data_batch, teacher_batch, optimizer, **kwargs):
        ...
        Returns:
            dict: It should contain at least 3 keys: ``loss``, ``log_vars``,
                ...
                averaging the logs.
        """
        losses = self.forward(teacher_batch['input'], **data_batch)
